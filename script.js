...
const QUESTION_BANK = [
  ...
  {"id": 404, "question": "How do Goyer, Redding, and Richey define an interview?", "options": ["A casual conversation between two friends.", "A planned, purposeful, person-to-person communication involving two parties.", "A one-way lecture by an employer to a candidate.", "A social gathering intended to build office culture."], "answer": 1},
  {"id": 405, "question": "What is the primary goal of the \"Screening Stage\" in the typical sequence of interviews?", "options": ["To finalize salary negotiations.", "To filter out unqualified applicants.", "To introduce the candidate to the CEO.", "To sign the employment contract."], "answer": 1},
  {"id": 406, "question": "In which stage of the interview sequence is the candidate most likely to emphasize their personality?", "options": ["Screening Stage", "Selection Stage", "Final Stage", "Pre-employment Testing Stage"], "answer": 2},
  {"id": 407, "question": "Which type of interview involves difficult questions and an unfriendly environment to test composure?", "options": ["Structured Interview", "Open-ended Interview", "Stress Interview", "Video Interview"], "answer": 2},
  {"id": 408, "question": "What is the defining characteristic of a \"Structured Interview\"?", "options": ["The interviewer asks whatever comes to mind.", "It is held in a formal boardroom only.", "It follows a series of prepared questions in a specific order.", "It involves multiple candidates at the same time."], "answer": 2},
  {"id": 409, "question": "When researching \"The Organization,\" which of the following should you investigate?", "options": ["Job functions and qualifications.", "Salary range and travel requirements.", "Industry position, earnings, and growth.", "The names of your future team members."], "answer": 2},
  {"id": 410, "question": "Which of the following falls under researching \"The Opportunity\"?", "options": ["The full name and age of the company.", "The location of the company headquarters.", "The job title, functions, and career path.", "The company's overall organizational structure."], "answer": 2},
  {"id": 411, "question": "Why does the text suggest asking \"why the vacancy exists\" during an interview?", "options": ["To be nosy about office gossip.", "To understand the role's history and potential challenges.", "To see if you can get a higher salary than the last person.", "To find out if the company is going bankrupt."], "answer": 1},
  {"id": 412, "question": "What is the primary purpose of pre-employment \"Psychological tests\"?", "options": ["To check for physical fitness.", "To determine technical coding skills.", "To assess personality traits and fit for the organization.", "To verify an educational degree."], "answer": 2},
  {"id": 413, "question": "What is the focus of the \"Warm-Up\" phase of an interview?", "options": ["Salary negotiation and benefits.", "Technical skills testing.", "First impressions and body language.", "Signing a non-disclosure agreement."], "answer": 2},
  {"id": 414, "question": "During the \"Question and Answer\" stage, what is just as important as speaking?", "options": ["Checking your watch for the time.", "Listening to the interviewer.", "Memorizing the office layout.", "Checking your phone for notifications."], "answer": 1},
  {"id": 415, "question": "How should a candidate handle \"Personal Questions\" during an interview?", "options": ["Refuse to answer and walk out.", "Answer with total transparency, even if irrelevant.", "Deal with them professionally while staying focused on job fit.", "Lie to make yourself sound more interesting."], "answer": 2},
  {"id": 416, "question": "What is a key task during the \"Close\" of the interview?", "options": ["Complaining about the length of the process.", "Concluding gracefully and reviewing notes.", "Asking for an immediate cash advance.", "Telling the interviewer you have a better offer elsewhere."], "answer": 1},
  {"id": 417, "question": "According to the text, how should a professional handshake be performed?", "options": ["It should be horizontal.", "It should be a \"bone-crusher\" to show strength.", "It should be vertical and assertive.", "Handshakes should be avoided."], "answer": 2},
  {"id": 418, "question": "What does \"Mirroring\" the interviewer's posture achieve?", "options": ["It makes the candidate look like they are mocking.", "It builds rapport and establishes a sense of connection.", "It shows the candidate is distracted.", "It indicates the candidate is bored."], "answer": 1},
  {"id": 419, "question": "What does leaning forward slightly toward the interviewer imply?", "options": ["Aggression and hostility.", "Interest and engagement.", "That the candidate is feeling dizzy.", "Disrespect for personal space."], "answer": 1},
  {"id": 420, "question": "Regarding arm and hand placement during an interview, the text suggests:", "options": ["Keeping them crossed defensively.", "Keeping them open rather than crossed.", "Hiding them under the table.", "Playing with hair or ears to show energy."], "answer": 1},
  {"id": 421, "question": "Why is sitting to one side often better than sitting directly face-to-face in an interview?", "options": ["It is less confrontational.", "It allows you to see the exit more clearly.", "It makes it easier to look at your notes.", "It is the only way to sit in most offices."], "answer": 0},
  {"id": 422, "question": "What is the best strategy for answering \"What are your weaknesses?\"", "options": ["Claim you have no weaknesses.", "Mention a technical skill you haven't learned yet.", "Cite a corrected weakness or a lesson learned.", "Blame your previous boss for your flaws."], "answer": 2},
  {"id": 423, "question": "If asked a \"Hypothetical Question\" in an interview, how should you respond?", "options": ["Say \"I don't know because it hasn't happened.\"", "Recall a similar real-life experience and explain how you handled it.", "Give a short, one-word answer.", "Ask the interviewer to answer it first."], "answer": 1},
  {"id": 424, "question": "When explaining why you left a previous job, you should:", "options": ["Be honest but avoid \"knocking\" your previous employer.", "Be as emotional as possible to get sympathy.", "Lie so you don't look like a \"job hopper.\"", "Refuse to discuss it."], "answer": 0},
  {"id": 425, "question": "Your answers in an interview should try to be:", "options": ["Long-winded and complex.", "Concise, accurate, and helpful.", "Vague so you don't commit to anything.", "Focused only on your personal life."], "answer": 1},
  {"id": 426, "question": "Which message is sent to check the status of your job application?", "options": ["Thank-you message.", "Inquiry message.", "Job acceptance letter.", "Job refusal letter."], "answer": 1},
  {"id": 427, "question": "When should a \"Thank-you message\" be sent after an interview?", "options": ["One month after the interview.", "Only if you are 100% sure you got the job.", "Shortly after the interview to show appreciation and interest.", "Never; it makes you look desperate."], "answer": 2},
  {"id": 428, "question": "Which letter is used to formally leave your current position?", "options": ["Job refusal letter.", "Thank-you letter.", "Resignation letter.", "Follow-up letter."], "answer": 2},
  {"id": 429, "question": "According to \"The Typical Sequence of Interviews,\" what is the primary purpose of the Selection Stage?", "options": ["To introduce the candidate to the office janitorial staff.", "To cover the candidate's strong points and qualifications in-depth.", "To perform a background check on the candidate's family.", "To provide a tour of the local city and housing options."], "answer": 1},
  {"id": 430, "question": "Which type of interview is conducted using online platforms to save on travel costs and time?", "options": ["Stress Interview", "Video Interview", "Group Interview", "Situational Interview"], "answer": 1},
  {"id": 431, "question": "In a \"Situational Interview,\" the interviewer's main goal is to:", "options": ["See how the candidate behaves in social settings.", "Evaluate how the candidate would handle specific job-related scenarios.", "Check the candidate's physical fitness for the role.", "Discuss the candidate's preferred vacation spots."], "answer": 1},
  {"id": 432, "question": "What is the benefit of \"Researching the Organization\" before an interview?", "options": ["It allows the candidate to dictate the company's future stock price.", "It helps the candidate build confidence and ask intelligent questions.", "It guarantees the candidate will receive a higher salary than others.", "It is a legal requirement in most countries before an interview."], "answer": 1},
  {"id": 433, "question": "According to the \"Wizard of Oz\" quote used in the lecture, what is the core advice for candidates?", "options": ["Always follow the yellow brick road.", "Believe in yourself.", "Never trust a man behind a curtain.", "Always bring a gift for the interviewer."], "answer": 1},
  {"id": 434, "question": "What is the primary function of a psychological test within the framework of pre-employment testing?", "options": ["To assess a candidate's mental or emotional characteristics, such as personality and aptitude.", "To verify a candidate's proficiency in skills directly applicable to the job function.", "To determine a candidate's ethical and financial trustworthiness.", "To screen for substance abuse which may impair job performance."], "answer": 0},
  {"id": 435, "question": "When preparing for an interview, which of the following is listed as one of the four key general areas for which a candidate should anticipate the employer's questions?", "options": ["Previous salary history and compensation negotiations.", "Attitudes and preferences regarding work and professional life.", "Personal financial status and credit history.", "Reasons for declining past job offers."], "answer": 1},
  {"id": 436, "question": "What is the correct and typical sequence of the three main stages of employment interviews?", "options": ["Final stage, Selection stage, Screening stage.", "Warm-up phase, Question-and-answer stage, The close.", "Screening stage, Selection stage, Final stage.", "Structured interview, Open-ended interview, Group interview."], "answer": 2},
  {"id": 437, "question": "If a candidate is asked \"What are your weaknesses?\", which strategy allows the candidate to mitigate the issue by demonstrating professional remediation?", "options": ["Present a weakness that's really a hidden strength.", "Cite a corrected weakness.", "Reveal a lapsed skill that is easily retrainable.", "Use an unrelated skill to deflect from the question."], "answer": 1},
  {"id": 438, "question": "What is the recommended approach for a candidate to answer hypothetical questions during the interview?", "options": ["Try to recall something similar in your experience and make it clear.", "Ask the interviewer to clarify the assumptions and desired outcome of the scenario.", "Stick to the point by only discussing the theory behind the solution.", "Always answer with an objective that was previously cited."], "answer": 0},
  {"id": 439, "question": "Which of the following is categorized as a type of Follow-up Message sent after the interview has concluded?", "options": ["Inquiry messages.", "Job refusal letter.", "Resigning from a job.", "Requesting more time to consider an offer."], "answer": 0},
  {"id": 440, "question": "In the three-step sequence of the employment interview, which stage is primarily concerned with assessing the candidate's ability to align their personal objectives with the company's requirements?", "options": ["Screening stage.", "Final stage.", "Warm-up phase.", "Selection stage."], "answer": 3},
  {"id": 441, "question": "Which action is one of the three components that define the close of the Interview phase?", "options": ["Discussing salary and negotiating benefits.", "Engaging in synchronized nodding and smiling.", "Asking the interviewer, \"What sort of future can I expect?\"", "Immediately sending a Thank-you message to the interviewer."], "answer": 0},
  {"id": 442, "question": "Which component of pre-employment testing is designed to evaluate a candidate's competence in the practical execution of a job-related task?", "options": ["Psychological tests.", "Drug tests.", "Job-skills tests.", "Polygraph tests."], "answer": 2},
  {"id": 443, "question": "Which specific goal must the interviewer achieve in relation to the candidate's professional background, as listed among their priorities?", "options": ["To confirm whether the qualifications stated are both genuine and relevant to the job.", "To assess the candidate's financial intelligence and overall wealth adequacy for the company's profile.", "To determine if the candidate can start immediately without any requirement for initial training.", "To evaluate the candidate's ability to hire and train subordinate staff in the future."], "answer": 0},
  {"id": 444, "question": "When a candidate researches the organization before an interview, which item is categorized under researching the opportunity?", "options": ["The age and geographic location of the organization.", "The history of the company.", "Job qualifications required for the specific position.", "The full corporate name."], "answer": 2},
  {"id": 445, "question": "Which type of interview involves posing hypothetical scenarios to the candidate to evaluate their problem-solving process and potential actions in a job-related crisis?", "options": ["Group interview.", "Stress interview.", "Open-ended interview.", "Situational interview."], "answer": 3},
  {"id": 446, "question": "Which statement accurately completes Goyer, Redding, and Richey's definition of an interview? An interview is a form of oral communication involving two parties, at least one of whom has a preconceived and serious purpose, and:", "options": ["where the dialogue is structured primarily to discuss salary and career trajectory.", "both of whom speak and listen from time to time.", "where the exchange is purposeful, planned, and decision-making.", "both of whom have provided a written CV and cover letter."], "answer": 1},
  {"id": 447, "question": "According to the objectives outlined in the source, what is the specific primary goal of the applicant during the employment interview process?", "options": ["To match their personal goals and abilities with the requirements of the job.", "To differentiate themselves from other candidates during the initial screening stage.", "To ascertain the organization's long-term earnings and growth potential.", "To negotiate the highest possible salary and benefits package."], "answer": 0},
  {"id": 448, "question": "Which non-verbal cue is explicitly identified as implying interest to the interviewer?", "options": ["Maintaining perfectly still hands and arms.", "Leaning forward slightly towards the interviewer.", "Sitting to one side rather than face to face.", "Mirroring the interviewer's posture exactly."], "answer": 1},
  {"id": 449, "question": "Which of the following is essential when preparing for behavioral interviews?", "options": ["Memorizing generic answers", "Thinking about transferable skills", "Avoiding company research", "Giving one-word responses"], "answer": 1},
  {"id": 450, "question": "In situational interviews, candidates should follow which structure?", "options": ["Focus only on outcomes", "Describe situation, action, and outcome", "Avoid discussing implications", "Give vague answers"], "answer": 1},
  {"id": 451, "question": "Which phrase is recommended during phone interviews after giving a short answer?", "options": ["\"That's all.\"", "\"Would you like more information?\"", "\"I don't know.\"", "\"Next question please.\""], "answer": 1},
  {"id": 452, "question": "Video interviews in the modern workplace can be of two types:", "options": ["Recorded and live", "Written and oral", "Group and individual", "Technical and HR"], "answer": 0},
  {"id": 453, "question": "When preparing a videotape interview, one must:", "options": ["Keep answers vague", "Tape only once", "Be specific and detailed", "Avoid smiling"], "answer": 2},
  {"id": 454, "question": "Successful interviewees are usually characterized by being:", "options": ["Vague about job positions", "Consistent and specific about desired roles", "Neutral in tone", "Silent about company knowledge"], "answer": 1},
  {"id": 455, "question": "Unsuccessful interviewees often exhibit which behavior regarding the company they are applying to?", "options": ["Use company name frequently", "Smile often", "Rarely use company name", "Ask personalized questions"], "answer": 2},
  {"id": 456, "question": "Successful candidates demonstrate enthusiasm during an interview by:", "options": ["Saying \"Okay\" neutrally", "Expressing approval verbally and nonverbally", "Avoiding eye contact", "Giving short answers"], "answer": 1},
  {"id": 457, "question": "Which nonverbal cue is linked to interview success?", "options": ["Little eye contact", "Smiling infrequently", "Frequent eye contact and smiling", "Crossing arms away from interviewer"], "answer": 2},
  {"id": 458, "question": "Successful interviewees use which type of language to show expertise?", "options": ["No technical jargon", "General responses only", "Industry terms and technical jargon", "One-word answers"], "answer": 2},
  {"id": 459, "question": "Which of the following is considered a defensive nonverbal cue in an interview?", "options": ["Comfortable eye contact", "Pointing gestures", "Forward lean", "Head nodding"], "answer": 1},
  {"id": 460, "question": "Which of the following is considered a supportive nonverbal cue in an interview?", "options": ["Shaking the head", "Arms crossed", "Forward lean", "Prolonged eye contact"], "answer": 2},
  {"id": 461, "question": "Empathy in body language is primarily shown by which gesture?", "options": ["Leaning back", "Head nodding", "Hands on hips", "Staring elsewhere"], "answer": 1},
  {"id": 462, "question": "Equality in interviews is reflected by which spatial arrangement?", "options": ["Maintaining higher elevation", "Hands on hips", "Same elevation as interviewer", "Extended eye contact aggressively"], "answer": 2},
];
